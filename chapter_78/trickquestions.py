...
QUESTIONS = [
    ...
    {'question': "Imagine you are in a haunted house full of evil ghosts. What do you have to do to stay safe?",
     ...
     'accept': ['nothing', 'stop']},
    {
        'question': "A taxi driver is going the wrong way down a one-way street. She passes ten cops but doesn't get "
                    "a ticket. Why not?",
    ...
    {
        'question': "If you're in the middle of a square house facing the west side with the south side to your left "
                    "and the north side to your right, which side of the house are you next to?",
    ...
    {'question': "What five-letter word becomes shorter by adding two letters?",
     'answer': "Short.",
     'accept': ['short']},
    {'question': "Gwen's mother has five daughters. Four are named Haha, Hehe, Hihi, and Hoho. What's the fifth "
                 "daughter's name?",
     'answer': "Gwen.",
     'accept': ['gwen']},
    ...
    {'question': "Where was the United States Declaration of Independence signed?",
     ...
     'accept': ['bottom']},
    {'question': "A person puts two walnuts in their pocket but only has one thing in their pocket five minutes later. "
                 "What is it?",
     'answer': "A hole.",
     'accept': ['hole']},
    ...
    {'question': "If you drop a raw egg on a concrete floor, will it crack?",
     ...
     'accept': ['no']},
    {
        'question': "If it takes ten people ten hours to build a fence, how many hours does it take five people to "
                    "build it?",
    ...
    {
        'question': "An electric train leaves the windy city of Chicago at 4pm on a Monday heading south at 100 "
                    "kilometers per hour. Which way does the smoke blow from the smokestack?",
    ...
    {
        'question': "A doctor gives you three pills with instructions to take one every half-hour. How long will the "
                    "pills last?",
        'answer': "One hour.",
        'accept': ['1', 'one']},
